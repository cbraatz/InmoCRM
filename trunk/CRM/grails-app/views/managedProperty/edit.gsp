...
<html>
    ...
    <body>
        <a href="#edit-managedProperty" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-managedProperty" class="content scaffold-edit" role="main">
