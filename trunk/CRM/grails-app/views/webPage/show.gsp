    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="list" action="index"><g:message code="default.list.label" args="[entityName]" params="[pid: managedProperty?.id]"/></g:link></li>
                <li><g:link class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></li>
                <li><g:link class="return" action="show" controller="managedProperty" id="${webPage?.managedProperty?.id}"><g:message code="managedProperty.label" default="Managed Property" /></g:link></li>
            </ul>
        </div>
