...
<html>
    ...
    <body>
        <a href="#list-commissionRate" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-commissionRate" class="content scaffold-list" role="main">
