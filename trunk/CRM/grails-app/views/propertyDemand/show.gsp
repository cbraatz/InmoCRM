        ...
        <div id="show-propertyDemand" class="content scaffold-show" role="main">
            ...
            <div class="message" role="status">${flash.message}</div>
				...
				<g:if test="${propertyDemand.isSellDemand}">     
		            ...
		            <f:table collection="${propertyDemand.getSmartMatchesForSellDemand()}" properties="['addedDate']" />
	            </g:if>
	            <g:else>     
		            <h1><g:message code="propertyDemand.sell.smart.matches.title"/></h1>
		            <f:table collection="${propertyDemand.getSmartMatchesForBuyDemand()}" properties="['addedDate']" />
	            </g:else>
