...
<html>
    ...
    <body>
        <a href="#list-reportDesigner" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-reportDesigner" class="content scaffold-list" role="main">
