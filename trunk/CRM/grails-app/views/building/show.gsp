    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="return" action="show" controller="managedProperty" id="${building?.managedProperty?.id}"><g:message code="managedProperty.label" default="Managed Property" /></g:link></li>
            </ul>
        </div>
